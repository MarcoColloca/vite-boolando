...
<template>
    <footer class="page-footer">
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <p class="page-footer__logo-txt">Boolando s.r.l.</p>
                    <ul class="footer-info">
                        <li>
                            <a href="#">Infoemazioni legali</a>
                        </li>

                        <li>
                            <a href="#">Informazioni Privacy</a>
                        </li>

                        <li>
                            <a href="#">Diritto Recesso</a>
                        </li>
                    </ul>
                </div>

                <div class="col-6 txt-end">
